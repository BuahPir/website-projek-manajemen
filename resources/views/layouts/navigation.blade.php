    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        ...
        <nav class="flex flex-1 flex-col">
            ...
            <li>
                ...
                <li>
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                        <svg class="h-6 w-6 shrink-0 group-hover:text-indigo-600 {{ Request::is('home') ? 'text-indigo-600' : 'text-gray-400'}}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
